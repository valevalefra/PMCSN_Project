...
def plot_stats_global():
    ...
    plt.legend(["seed = " + str(dict_list[0]["seed"]), "seed = " + str(dict_list[1]["seed"]),
                "seed = " + str(dict_list[2]["seed"]), "seed = " + str(dict_list[3]["seed"]), "seed = " + str(dict_list[4]["seed"])])
    ...
    if stationary:
        plt.savefig(fname=results_dir + "/adv_avg_ws_aft_s", bbox_inches='tight')
    else:
        plt.savefig(fname=results_dir + "/adv_transient_aft_ns", bbox_inches='tight')
    plt.show()
